...
if(opts.title=='主页'){
    var tool=$("<div class=\"panel-tool\" style='display: none;'></div>").appendTo(_167);
}else{
...
pp.panel("header").addClass("accordion-header").click(function(){
    if(pp.panel("options").title=='主页'){
        //选中主页时，如果当前打开的不是主页，则展示主页
        if($('#tabs').tabs('exists','主页')){
            $('#tabs').tabs('close','主页');
            $('#tabs').tabs('add',{
                title:'主页',
